...
int main() {
    double **matrix_1, **matrix_2, **res_matrix_1;

    matrix_1 = matrix_2 = res_matrix_1 = {0};
...
void AutoVectorizedMultiplyMatrices(double **result_matrix, double **matrix_1, double **matrix_2, int M, int N, int K,
                                    int I) {
